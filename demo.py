...
if __name__ == '__main__':
    ...
    if args.dataset == 'pascal_voc':
        ...
        with open('data/openimages/cache/class_names.pkl', 'rb') as f:
    ...
    if webcam_num >= 0:
        ...
        imglist = [img for img in os.listdir(args.image_dir) if 'jpg' in img or 'png' in img]
    ...
    while (num_images >= 0):
        ...
        if vis and webcam_num == -1:
            ...
            # cv2.waitKey(0)
            result_path = os.path.join(args.image_dir, 'output', imglist[num_images][:-4] + "_det.jpg")
